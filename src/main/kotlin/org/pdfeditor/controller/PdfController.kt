...
class PdfController(private val pdfService: PdfService) {
   ...
   * @return ResponseEntity containing the modified PDF as a byte array
   */
  ...
  fun deletePages(
    ...
    return ResponseEntity.ok()
      .header(
        ...
        "attachment; filename=\"modified-${file.originalFilename}\""
      )
  ...
  fun extractPages(
    ...
    return ResponseEntity.ok()
      .header(
        HttpHeaders.CONTENT_DISPOSITION,
        "attachment; filename=\"extracted-${file.originalFilename}\""
      )
      .contentType(MediaType.APPLICATION_PDF)
      .body(result)
  }
  ...
  fun optimizePdf(
    ...
    return ResponseEntity.ok()
      .header(
        HttpHeaders.CONTENT_DISPOSITION,
        "attachment; filename=\"optimized-${file.originalFilename}\""
      )
      .contentType(MediaType.APPLICATION_PDF)
      .body(result)
  }
